...
const GradientAnalyticalDashboard = ({ className }) => {
      ...
      {theme === 'light' && (
        <>
          ...
          <Light.Medium className={clsx(
            'hidden sm:block lg:hidden left-0',
            className
          )}/>
          <Light.Small className={clsx(
            'block sm:hidden left-0',
            className
          )}/>
        </>
      )}
...
GradientAnalyticalDashboard.propTypes = {
  className: PropTypes.string
}

export default GradientAnalyticalDashboard
