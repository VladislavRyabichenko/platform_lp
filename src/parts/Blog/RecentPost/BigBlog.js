...
import UserImage from 'assets/img/insight/recent-post/blog-1/user.png'
  ...
  return (
    ...
    >
      ...
      <Link to="/blog/From-avoiding-FOMO">
        <p className="text-m-bold md:text-l-bold text-black dark:text-white mt-5">From avoiding FOMO to having a plan, 5 key ways to manage a crypto down cycle</p>
      </Link>
      ...
      <div className="flex items-center space-x-3 mt-6">
        ...
        <div className="space-y-1">
          <p className="text-s-medium md:text-m-medium text-black dark:text-white">Courtney Henry</p>
          <div className="flex items-center space-x-2">
            <p className="text-xs-reguler md:text-s-reguler text-black/60 dark:text-white/[0.56]">16 Mar 2022</p>

            <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle className="fill-black/[0.08] dark:fill-white/20" cx="2" cy="2" r="2"/>
            </svg>

            <p className="text-xs-reguler md:text-s-reguler text-black/60 dark:text-white/[0.56]">16 min read</p>
          </div>
        </div>
      </div>
    </motion.div>
